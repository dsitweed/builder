...
const UndergradStudentDialog = ({ open, setOpen, data, setData }) => {
  ...
  return (
    ...
    >
      {(formik) => (
        <DataDialog
          name={t("undergradStudents")}
          path="struct.undergradStudents.items"
          {...{ open, setOpen, data, setData }}
        >
          <div className="grid grid-cols-2 gap-8">
            <Input
              label={t("fullNameStudent")}
              className="col-span-2"
              placeholder={t("namePlaceholderStudent")}
              isBoldLabel={true}
...
export default memo(UndergradStudentDialog);
